  ...
  return (
    <>
      ...
      <header className="mb-8">
        ...
        <p className="mt-4 max-w-3xl text-lg leading-8 text-muted-foreground">Validate a policy and inspect its expansion without a database snapshot. Then compare it with a current-state snapshot: the same Rust planner used by pgroles produces ordered changes, phase analysis, findings, and a graph.</p>
        <p className="mt-3 text-muted-foreground">No command exports snapshots yet. Write your own in the <Link href="/docs/explorer-snapshots">snapshot format</Link> and scrub role settings and comments by hand first.</p>
